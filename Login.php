<?php
  ...
  $prepared_database = new PDO("mysql:host=$hostname;dbname=$database;charset=utf8mb4", $username, $password);
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-form u-form-1">
          <form action="" method="post" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" style="padding: 10px;">
            <input type="text" placeholder="Introduceti numele" id="name-82e6" name="username" class="u-border-1 u-border-grey-30 u-gradient u-input u-input-rectangle u-palette-2-light-3 u-input-1" required="" control-id="ControlID-589">
            <input placeholder="Introduceti parola" name="password" class="u-border-1 u-border-grey-30 u-gradient u-input u-input-rectangle u-palette-2-light-3 u-input-2" required="" control-id="ControlID-590">
          ...
          <div style="color:white;">
            ...
            if(isset($_POST["username"]) && isset($_POST["password"])) {
              ...
              $prepared_select = $prepared_database->prepare("SELECT id FROM atestat_user WHERE username = :username AND password = :password");
              $prepared_select->execute(array(':username' => $username, ':password' => $password));
        ...
        <a href="Creaza-cont.php" class="u-border-1 u-border-active-palette-2-base u-border-hover-palette-2-light-1 u-border-no-left u-border-no-right u-border-no-top u-btn u-button-style u-none u-text-hover-custom-color-2 u-text-palette-1-light-3 u-btn-3">Nu ai cont incă? Creaza-ti un cont</a>
      </div>
    </section>
