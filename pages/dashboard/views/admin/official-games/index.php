...
<section>
    ...
    <div class="desktop-view">
        <a class="add-game-button" href="/atestat/pages/dashboard/views/admin/add-game/index.php">ADAUGĂ JOC</a>
        <div class=" desktop-game-info-container">
            ...
            foreach ($games as $game) {
                ...
                <span>
                    <a class="edit" href=<?= "/atestat/pages/dashboard/views/admin/edit-game/index.php?joc-id=" . $game["id"] ?>>EDITEAZĂ</a>
